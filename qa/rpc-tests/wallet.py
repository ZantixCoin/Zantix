...
#   c) node1 mines 32 blocks, so now node 0 has 500000ZNTX, node 1 has 4250ZNTX, node2 has none.
#   d) node0 sends 601 ZNTX to node2, in two transactions (301 ZNTX, then 300 ZNTX).
