...
This mechanism has been integrated into Bitcore-Node-Zantix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zantix/insight-api-zantix#web-socket-api](https://github.com/zantix/insight-api-zantix#web-socket-api)
* API: [https://github.com/zantix/insight-api-zantix#swifttx-transactions](https://github.com/zantix/insight-api-zantix#swifttx-transactions)
...
By default, the Zantix Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zantix Core daemon:
