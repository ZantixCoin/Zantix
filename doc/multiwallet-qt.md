...
In order to support loading of multiple wallets in zantix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zantix.cpp.
...
Changes to zantix.cpp
----------------------
zantix.cpp is the entry point into zantix-qt, and as such, will require some minor modifications to provide hooks for
