...
### Build and sign Zantix Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit zantix=v${VERSION} ../zantix/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [zantix-detached-sigs](https://github.com/ZantixCoin/Zantix-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
