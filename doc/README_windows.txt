...
Intro
-----
Zantix (ZNTX) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. Zantix utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run zantix-qt.exe.

Zantix Core is the original Zantix client and it builds the backbone of the network.
However, it downloads and stores the entire history of Zantix transactions;
