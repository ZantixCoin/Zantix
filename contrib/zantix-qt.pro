...
RESOURCES += src/qt/zantix.qrc src/qt/zantix_locale.qrc

TRANSLATIONS += src/qt/locale/zantix_bg.ts \
                src/qt/locale/zantix_de.ts \
                src/qt/locale/zantix_en.ts \
                src/qt/locale/zantix_es.ts \
                src/qt/locale/zantix_fi.ts \
                src/qt/locale/zantix_fr.ts \
                src/qt/locale/zantix_it.ts \
                src/qt/locale/zantix_ja.ts \
                src/qt/locale/zantix_pl.ts \
                src/qt/locale/zantix_pt.ts \
                src/qt/locale/zantix_ru.ts \
                src/qt/locale/zantix_sk.ts \
                src/qt/locale/zantix_sv.ts \
                src/qt/locale/zantix_vi.ts \
                src/qt/locale/zantix_zh_CN.ts \
                src/qt/locale/zantix_zh_TW.ts
