...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zantix features */
        {"zantix", "masternode", &masternode, true, true, false},
        {"zantix", "listmasternodes", &listmasternodes, true, true, false},
        {"zantix", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zantix", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zantix", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zantix", "masternodedebug", &masternodedebug, true, true, false},
        {"zantix", "startmasternode", &startmasternode, true, true, false},
        {"zantix", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zantix", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zantix", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zantix", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zantix", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zantix", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zantix", "mnbudget", &mnbudget, true, true, false},
        {"zantix", "preparebudget", &preparebudget, true, true, false},
        {"zantix", "submitbudget", &submitbudget, true, true, false},
        {"zantix", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zantix", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zantix", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zantix", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zantix", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zantix", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zantix", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zantix", "checkbudgets", &checkbudgets, true, true, false},
        {"zantix", "mnsync", &mnsync, true, true, false},
        {"zantix", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> zantix-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24401/\n";
}
