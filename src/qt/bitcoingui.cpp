                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zantix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZNTX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zantix: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zantix Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zantix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zantix"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZNTX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZNTX addresses"));
    ...
    openAction->setStatusTip(tr("Open a zantix: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zantix Core help message to get a list with possible Zantix command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zantix Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Zantix Core"); // default title
