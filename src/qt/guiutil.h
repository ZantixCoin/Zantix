...
/** Utility functions used by the Zantix Qt UI.
 */
namespace GUIUtil
{
...
// Render ZNTX addresses in monospace font
...
// Parse "zantix:" URI into recipient object, return true on successful parsing
