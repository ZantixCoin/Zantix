...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1 * 60;  //  Zantix: 1 minute
        nMaturity = 10;
        ...
        // Zantix BIP44 coin type is '222' (0x800000de)
        ...
        strMasternodePoolDummyAddress = "ZyKRJP3ztgvQhLrDZ242BY4qybaJtccKur";
...
/** End generating the testnet Genesis **/
        ...
        // Testnet Zantix BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Zantix BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Zantix BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        /** End generating the regtest Genesis **/
