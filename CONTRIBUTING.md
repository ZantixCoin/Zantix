Contributing to Zantix Core
==================================

The Zantix Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zantix Core project, and is not to be
confused with overall Zantix Network Protocol consensus changes.

Whether a pull request is merged into Zantix Core rests with the project merge
...
Patches that change Zantix consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zantix consensus, it must have been
...
The project lead is the release manager for each Zantix Core release.
